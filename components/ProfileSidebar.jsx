...
const ProfileSidebar = () => {
  ...
  return (
    <section className={`w-full h-full rounded-md`}>
      <div className="w-full h-full md:px-2 md:py-4 flex flex-col">
        {/* all menu */}
        <div className="w-full flex gap-1 md:gap-2 flex-col">
          {/* main menu */}
          <div className=" w-full flex md:gap-2 flex-col">
            {/* title */}
            <div className="hidden md:block">
              <h1 className="text-[#94A7CB66] font-semibold text-xs">M A I N M E N U</h1>
            </div>
            {/* menu */}
            <div className="flex flex-col gap-1">
              ...
              <Link
                ...
                className={`${
                  pathname == "/dashbord"
                    ? "bg-primary-dark-500 text-primary-white"
                    : "text-secondinary-light-300"
                } p-2 md:p-3 cursor-pointer gap-4 rounded-md hover:text-primary-white hover:bg-primary-dark-500 flex items-center`}
              >
                <span>
                  <svg
                ...
                <h2 className="text-sm md:text-base font-medium">Dashboard</h2>
              </Link>
              {/* single menu item */}
              <Link
                href="/carrent"
              ...
              >
                ...
                <h2 className="text-sm md:text-base font-medium">Car Rent</h2>
              </Link>
              {/* single menu item */}
              <Link
                href="/insight"
              ...
              >
                ...
                <h2 className="text-sm md:text-base font-medium">Insight</h2>
              </Link>
              {/* single menu item */}
              <Link
                href="/reimburse"
              ...
              >
                ...
                <h2 className="text-sm md:text-base font-medium">Reimburse</h2>
              </Link>
              {/* single menu item */}
              <Link
                href="/inbox"
              ...
              >
                ...
                <h2 className="text-sm md:text-base font-medium">Calender</h2>
              </Link>
            </div>
          </div>
          {/* prefrences */}
          <div className=" w-full flex md:gap-2 flex-col">
            {/* title */}
            <div className="hidden md:block">
              <h1 className="text-[#94A7CB66] font-semibold text-xs">P R E F E R E N C E S</h1>
            </div>
            {/* menu */}
            <div className="flex flex-col gap-1">
              {/* single menu item */}
              ...
              >
                ...
                <h2 className="text-sm md:text-base font-medium">Settings</h2>
              </Link>
              {/* single menu item */}
              <Link
                href="/help"
              ...
              >
                ...
                <h2 className="text-sm md:text-base font-medium">Help & Center</h2>
              </Link>
              {/* single menu item */}
              <div className="pl-2 md:pl-4 text-secondinary-light-300 gap-2 rounded-md flex items-center">
                <div className="flex items-center gap-4">
                  ...
                  <h2 className="tex-sm md:text-base font-medium">Dark Mode</h2>
                </div>
        ...
        <div className="w-full">
          <button className="w-full p-2 md:p-4 rounded-md text-secondinary-light-300 hover:bg-primary-dark-500 hover:text-primary-white flex items-center gap-2">
            <span>
              <svg
                className="w-5 h-5 md:w-6 md:h-6"
                viewBox="0 0 24 24"
            ...
            <h2 className="text-sm md:text-base font-medium">Log Out</h2>
          </button>
        </div>
      </div>
    </section>
